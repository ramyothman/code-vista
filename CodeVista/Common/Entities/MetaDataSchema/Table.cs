    ...
    public class Table : Entities.Entity
    {
        ...
        public string PluralName
        {
            ...
            get
            {
                ...
                System.Data.Entity.Design.PluralizationServices.PluralizationService pl = System.Data.Entity.Design.PluralizationServices.PluralizationService.CreateService(info);
                _pluralName = pl.Pluralize(Name).Substring(0,pl.Pluralize(Name).Length - 1) + pl.Pluralize(Name).Substring(pl.Pluralize(Name).Length - 1).ToLower();
                return _pluralName;
        ...
        public string SingularName
        {
            ...
            {
                System.Data.Entity.Design.PluralizationServices.PluralizationService pl = System.Data.Entity.Design.PluralizationServices.PluralizationService.CreateService(info);
                _singularName = pl.Singularize(Name);
